...
fprintf(1,'\n');
fprintf(1,...
    'Perform k = %2.0f iterations of AIR Tools sart matrix-free (takes a while...).\n',...
    num_iters);
...
fprintf(1,'\n');
fprintf(1,...
    'Perform k = %2.0f iterations of AIR Tools sart calling ASTRA for forward and backprojection.\n',...
    num_iters);
...
fprintf(1,'\n');
fprintf(1,...
    'Perform k = %2.0f iterations of ASTRA''s built-in sirt method, equivalent to AIR Tools sart.\n',...
    num_iters);
tic_builtin = tic;
