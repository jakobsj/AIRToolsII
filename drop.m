...
% column of A, and M = diag(1/||a_i||_2^2).
%
% Input:
...
%            M            : diagonal of the matrix M = diag(w_i/||a_i||^2_2)
...
% 2) Before calling drop, the user must assign values the parameters
...
%
% See also: cav, cimmino, landweber, sart, sirt.
